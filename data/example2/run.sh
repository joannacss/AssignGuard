...
CONFLICTS_OUTPUT="${REPO_ROOT}/results/example2-affiliation-conflicts.json"
REASSIGNMENTS_OUTPUT="${REPO_ROOT}/results/example2-reassignment-recommendations.json"
